...
class Config(object):
    ...
    if fine_tuning:
        ...
        lr = 0.001
    checkpoint = ""
    # checkpoint = "VisualSearch/mmc-amd-splitA-train/models/mmc-amd-splitA-val/config-mm-loose.py/run_1/best_epoch50_0.8928.pth"
    ...
    aug_params = {
        "augmentation": {
            # "output_shape": [299, 299] , #inception
            "output_shape": [448, 448] , #resnet, mobilenet, vgg
